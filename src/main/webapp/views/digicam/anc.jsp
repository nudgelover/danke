    ...
    <div class="toolbar" id="kt_toolbar">
        <div class="container-xxl d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-1">
                <!--begin::Title-->
                <h3 class="text-dark fw-bold my-1">FAQ</h3>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
            ...
            <div class="d-flex align-items-center flex-nowrap text-nowrap overflow-auto py-1">
                <a href="/digicam/anc" class="btn btn-active-accent active fw-bold">Notice</a>
                        ...
                        <div class="card-body py-10 px-6">
                            ...
                            <ul class="menu menu-column menu-rounded menu-gray-600 menu-hover-bg-light-primary menu-active-bg-light-primary fw-semibold mb-10">
                                <li class="menu-content fw-semibold pb-2 px-3">
                                    <span class="fs-3 fw-bold">Premium Authors</span>
                                </li>
                            ...
                            <!--end::Authors List-->
                            <!--begin::Theme List-->
                            <ul class="menu menu-column menu-rounded menu-gray-600 menu-hover-bg-light-primary menu-active-bg-light-primary fw-semibold">
                                <li class="menu-content fw-semibold pb-2 px-3">
                                    <span class="fs-3 fw-bold">Theme Customers</span>
                                </li>
                                <li class="menu-item px-3 pb-1">
                            ...
                            <div class="accordion accordion-icon-toggle" id="kt_accordion_1">
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="accordion-header py-3 d-flex" data-bs-toggle="collapse"
                                        ...
                                        <h3 class="fs-4 text-gray-800 fw-semibold mb-0 ms-4">The best way to quick start
                                            business</h3>
                                    </div>
                                    <!--end::Header-->
                                    <!--begin::Body-->
                                    <div id="kt_accordion_1_item_1" class="fs-6 collapse show ps-10"
                                         data-bs-parent="#kt_accordion_1">
                                        <div class="mb-5">Lorem Ipsum is simply dummy text of the printing and
                                        ...
                                        <div>It was popularised in the 1960s with the release of Letraset sheets
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="accordion-header py-3 d-flex collapsed" data-bs-toggle="collapse"
                                        ...
                                        <h3 class="fs-4 text-gray-800 fw-semibold mb-0 ms-4">How To Create Channel
                                            ?</h3>
                                    </div>
                                    <!--end::Header-->
                                    <!--begin::Body-->
                                    <div id="kt_accordion_1_item_2" class="collapse fs-6 ps-10"
                                         data-bs-parent="#kt_accordion_1">
                                        <div class="mb-5">There are many variations of passages of Lorem Ipsum
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="accordion-header py-3 d-flex collapsed" data-bs-toggle="collapse"
                                        ...
                                        <h3 class="fs-4 text-gray-800 fw-semibold mb-0 ms-4">What are the support terms
                                            & conditions ?</h3>
                                    </div>
                                    <!--end::Header-->
                                    <!--begin::Body-->
                                    <div id="kt_accordion_1_item_3" class="collapse fs-6 ps-10"
                                         data-bs-parent="#kt_accordion_1">Some plugins may ask for a purchase code for
                                        registration/activation once installed, however, you can simply ignore these
                                        messages as bundled plugins do not require activation or registration.
                                    </div>
                                    <!--end::Body-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="accordion-header py-3 d-flex collapsed" data-bs-toggle="collapse"
                                        ...
                                        <h3 class="fs-4 text-gray-800 fw-semibold mb-0 ms-4">What is the 6 Months
                                            support extention ?</h3>
                                    </div>
                                    <!--end::Header-->
                                    <!--begin::Body-->
                                    <div id="kt_accordion_1_item_4" class="collapse fs-6 ps-10"
                                         data-bs-parent="#kt_accordion_1">Some plugins may ask for a purchase code for
                                        registration/activation once installed, however, you can simply ignore these
                                        messages as bundled plugins do not require activation or registration. The
                                        plugin will still work as intended with the theme once the theme has been
                                        activated/registered. When a plugin is updated, the theme author will include
                                        the latest version of the bundled plugin with their next theme update.
                                    </div>
                                    <!--end::Body-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="accordion-header py-3 d-flex collapsed" data-bs-toggle="collapse"
                                        ...
                                        <h3 class="fs-4 text-gray-800 fw-semibold mb-0 ms-4">How can I keep up to date
                                            my item ?</h3>
                                    </div>
                                    <!--end::Header-->
                                    <!--begin::Body-->
                                    <div id="kt_accordion_1_item_5" class="collapse fs-6 ps-10"
                                         data-bs-parent="#kt_accordion_1">Some plugins may ask for a purchase code for
                                        registration/activation once installed, however, you can simply ignore these
                                        messages as bundled plugins do not require activation or registration. The
                                        plugin will still work as intended with the theme once the theme has been
