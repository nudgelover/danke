						...
						<div class="toolbar" id="kt_toolbar">
							<div class="container-xxl d-flex flex-stack flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-nowrap text-nowrap overflow-auto py-1">
									...
									<a href="../dist/apps/inbox.html" class="btn btn-active-accent active fw-bold ms-3">Inbox</a>
										...
										<div class="card">
											...
											<div class="card-header card-header-stretch">
												<ul class="nav nav-stretch nav-line-tabs border-bottom-0">
													<li class="nav-item">
														<a class="nav-link justify-content-center w-60px active" data-bs-toggle="tab" href="#">
													...
													<li class="nav-item">
														<a class="nav-link justify-content-center w-60px ms-0" data-bs-toggle="tab" href="#">
															<span class="nav-icon m-0">
											...
											<div class="card-body px-0 pb-0">
												...
												<div class="d-flex flex-stack px-9 mt-3 mb-10">
													...
													<div class="btn btn-light-primary fs-6 fw-bold py-2 px-4" id="kt_inbox_compose_toggle">Compose</div>
												</div>
												<!--end::Title-->
												<!--begin::Inbox Aside-->
													...
													<div data-action="list" class="mh-300px mh-lg-unset">
														...
														<div class="bg-state-light active px-9 py-8 d-flex" data-action="list">
															...
															<div class="d-flex flex-row-fluid flex-column">
																...
																<div class="fw-semibold fs-7 text-gray-600 mb-3">Outlines keep you honest. They stoping you from indulging in poorly of your post</div>
											...
											<div class="card-header align-items-center card-px">
												...
												<div class="d-flex align-items-center">
													...
													<div class="d-flex align-items-center me-1 my-2">
														...
														<a href="#" class="btn btn-icon btn-active-light-primary btn-sm me-2" data-bs-toggle="tooltip" title="Reply">
															...
															<div class="d-flex align-items-center flex-wrap w-xxl-200px me-3" data-bs-toggle="view">
																...
																<div class="symbol symbol-40px me-4">
																	<span class="symbol-label bg-light">
																		<img src="assets/media/svg/avatars/035-boy-15.svg" class="h-75 align-self-end" alt="" />
																	</span>
																</div>
																<!--end::Symbol-->
																<a href="#" class="fw-semibold text-gray-800 text-hover-primary">Sean Paul</a>
															</div>
															<!--end::Author-->
														</div>
														<!--end::Toolbar-->
													...
													<div class="d-flex align-items-start bg-hover-light card-px py-3" data-inbox="message">
														...
														<div class="d-flex align-items-center">
															...
															<div class="d-flex align-items-center flex-wrap w-xxl-200px me-3" data-bs-toggle="view">
																...
																<a href="#" class="fw-semibold text-gray-800 text-hover-primary">Oliver Jake</a>
															</div>
															<!--end::Author-->
														</div>
														<!--end::Toolbar-->
													...
													<div class="d-flex align-items-start bg-hover-light card-px py-3" data-inbox="message">
														...
														<div class="d-flex align-items-center">
															...
															<div class="d-flex align-items-center flex-wrap w-xxl-200px me-3" data-bs-toggle="view">
																...
																<a href="#" class="fw-semibold text-gray-800 text-hover-primary">Enrico Fermi</a>
															</div>
															<!--end::Author-->
														</div>
														<!--end::Toolbar-->
														...
														<!--end::Info-->
														<!--begin::Datetime-->
														<div class="mt-2 me-3 fw-normal w-100px text-end text-muted" data-bs-toggle="view">11:20PM</div>
														<!--end::Datetime-->
													</div>
													<!--end::Item-->
													<!--begin::Item-->
													<div class="d-flex align-items-start bg-hover-light card-px py-3" data-inbox="message">
														...
														<div class="d-flex align-items-center">
															...
															<div class="d-flex align-items-center me-3" data-inbox="actions">
																...
																<a href="#" class="btn btn-icon btn-sm text-hover-warning active" data-bs-toggle="tooltip" data-bs-placement="right" title="Mark as important">
																	<i class="fas fa-bookmark text-muted"></i>
																</a>
															</div>
															<!--end::Actions-->
															...
															<div class="d-flex align-items-center flex-wrap w-xxl-200px me-3" data-bs-toggle="view">
																...
																<!--end::Symbol-->
																<a href="#" class="fw-semibold text-gray-800 text-hover-primary">Jane Goodall</a>
															</div>
															<!--end::Author-->
														</div>
														<!--end::Toolbar-->
														...
														<!--end::Info-->
														<!--begin::Datetime-->
														<div class="mt-2 me-3 fw-normal w-100px text-end text-muted" data-bs-toggle="view">2 days ago</div>
														<!--end::Datetime-->
													</div>
													<!--end::Item-->
													<!--begin::Item-->
													<div class="d-flex align-items-start bg-hover-light card-px py-3" data-inbox="message">
														...
														<div class="d-flex align-items-center">
															...
															<div class="d-flex align-items-center me-3" data-inbox="actions">
																...
																<a href="#" class="btn btn-icon btn-sm text-hover-warning" data-bs-toggle="tooltip" data-bs-placement="right" title="Star">
																	<i class="fas fa-star text-muted"></i>
																</a>
																<a href="#" class="btn btn-icon btn-sm text-hover-warning active" data-bs-toggle="tooltip" data-bs-placement="right" title="Mark as important">
																	<i class="fas fa-bookmark text-muted"></i>
															...
															<div class="d-flex align-items-center flex-wrap w-xxl-200px me-3" data-bs-toggle="view">
																...
																<a href="#" class="fw-semibold text-gray-800 text-hover-primary">Max O'Brien Planck</a>
															</div>
															<!--end::Author-->
														</div>
														<!--end::Toolbar-->
														...
														<!--end::Info-->
														<!--begin::Datetime-->
														<div class="mt-2 me-3 fw-normal w-100px text-end text-muted" data-bs-toggle="view">July 25</div>
														<!--end::Datetime-->
													</div>
													<!--end::Item-->
													<!--begin::Item-->
													<div class="d-flex align-items-start bg-hover-light card-px py-3" data-inbox="message">
														...
														<div class="d-flex align-items-center">
															...
															<div class="d-flex align-items-center flex-wrap w-xxl-200px me-3" data-bs-toggle="view">
																...
																<!--end::Symbol-->
																<a href="#" class="fw-semibold text-gray-800 text-hover-primary">Rita Levi-Montalcini</a>
															</div>
															<!--end::Author-->
														</div>
														<!--end::Toolbar-->
														...
														<!--end::Info-->
														<!--begin::Datetime-->
														<div class="mt-2 me-3 fw-normal w-100px text-end text-muted" data-bs-toggle="view">July 24</div>
														<!--end::Datetime-->
													</div>
													<!--end::Item-->
													<!--begin::Item-->
													<div class="d-flex align-items-start bg-hover-light card-px py-3" data-inbox="message">
														...
														<div class="d-flex align-items-center">
															...
															<div class="d-flex align-items-center flex-wrap w-xxl-200px me-3" data-bs-toggle="view">
																...
																<!--end::Symbol-->
																<a href="#" class="fw-semibold text-gray-800 text-hover-primary">Stephen Hawking</a>
															</div>
															<!--end::Author-->
														</div>
														<!--end::Toolbar-->
														...
														<!--end::Info-->
														<!--begin::Datetime-->
														<div class="mt-2 me-3 fw-normal w-100px text-end text-muted" data-bs-toggle="view">July 13</div>
														<!--end::Datetime-->
													</div>
													<!--end::Item-->
													<!--begin::Item-->
													<div class="d-flex align-items-start bg-hover-light card-px py-3" data-inbox="message">
														...
														<div class="d-flex align-items-center">
															...
															<div class="d-flex align-items-center me-3" data-inbox="actions">
																...
																<a href="#" class="btn btn-icon btn-sm text-hover-warning text-hover-warning active" data-bs-toggle="tooltip" data-bs-placement="right" title="Star">
																	<i class="fas fa-star text-muted"></i>
																</a>
																<a href="#" class="btn btn-icon btn-sm text-hover-warning active" data-bs-toggle="tooltip" data-bs-placement="right" title="Mark as important">
																	<i class="fas fa-bookmark text-muted"></i>
															...
															<div class="d-flex align-items-center flex-wrap w-xxl-200px me-3" data-bs-toggle="view">
																...
																<a href="#" class="fw-semibold text-gray-800 text-hover-primary">Wolfgang Ernst Pauli</a>
															</div>
															<!--end::Author-->
														</div>
														<!--end::Toolbar-->
														...
														<!--end::Info-->
														<!--begin::Datetime-->
														<div class="mt-2 me-3 fw-semibold text-muted w-100px text-end" data-bs-toggle="view">25 May</div>
														<!--end::Datetime-->
													</div>
													<!--end::Item-->
													<!--begin::Item-->
													<div class="d-flex align-items-start bg-hover-light card-px py-3" data-inbox="message">
														...
														<div class="d-flex align-items-center">
															...
															<div class="d-flex align-items-center flex-wrap w-xxl-200px me-3" data-bs-toggle="view">
																...
																<!--end::Symbol-->
																<a href="#" class="fw-semibold text-gray-800 text-hover-primary">Patty Jo Watson</a>
															</div>
															<!--end::Author-->
														</div>
														<!--end::Toolbar-->
											...
											<div class="card-body">
												...
												<div class="d-flex flex-stack flex-wrap py-5">
													...
													<div class="d-flex align-items-center flex-wrap me-2 py-2">
														<div class="fw-semibold fs-2 me-3">Trip Reminder. Thank you for flying with us!</div>
														<div class="my-2">
														...
														<div class="d-flex align-items-center">
															...
															<div class="d-flex flex-column flex-grow-1 flex-wrap me-2">
																<div class="d-flex align-items-center flex-wrap">
																	<a href="#" class="fs-6 fw-bold text-gray-800 text-hover-primary me-2">Chris Muller</a>
																	<div class="fw-semibold fs-7 text-muted">
																	<span class="bullet bullet-dot bg-primary w-6px h-6px me-2"></span>1 Day ago</div>
																</div>
																<div class="d-flex flex-column">
																	<span class="fw-semibold text-muted cursor-pointer" data-bs-toggle="dropdown">to me
														...
														<form id="kt_inbox_reply_form">
															...
															<div class="d-block">
																...
																<div class="d-flex align-items-center border-bottom inbox-to px-8 min-h-50px">
																	...
																	<div class="ms-2">
																		<span class="text-muted fw-semibold cursor-pointer text-hover-primary me-2" data-inbox="cc-show">Cc</span>
																		<span class="text-muted fw-semibold cursor-pointer text-hover-primary" data-inbox="bcc-show">Bcc</span>
																	</div>
																</div>
																<!--end::To-->
																<!--begin::CC-->
															...
															<div class="d-flex flex-stack py-5 ps-8 pe-5 border-top">
																...
																<div class="d-flex align-items-center me-3">
																	...
																	<!--end::Send-->
																	<!--begin::Other-->
																	<a href="#" class="btn btn-icon btn-active-light-primary me-2" id="kt_inbox_reply_attachments_select">
																...
																<!--begin::Toolbar-->
																<div class="d-flex align-items-center">
																	<a href="#" class="btn btn-icon btn-active-light-primary me-2" data-bs-toggle="tooltip" title="More actions">
