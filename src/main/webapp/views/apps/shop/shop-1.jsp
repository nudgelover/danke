						...
						<div class="toolbar" id="kt_toolbar">
							<div class="container-xxl d-flex flex-stack flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-nowrap text-nowrap overflow-auto py-1">
									...
									<a href="../dist/apps/shop/shop-1.html" class="btn btn-active-accent active fw-bold ms-3">Shop 1</a>
											...
											<div class="card-body d-flex justify-content-between card-rounded p-0 d-flex bg-light-primary">
												<div class="d-flex flex-column flex-lg-row-auto p-10 p-md-20">
													...
													<form class="d-flex flex-center py-2 px-6 bg-white rounded">
														...
														<!--end::Svg Icon-->
														<input type="text" class="form-control border-0 fw-semibold ps-2 w-xxl-350px" placeholder="Search Goods" />
													</form>
													<!--end::Form-->
												</div>
														...
														<div class="card-body p-0">
															...
															<div class="overlay rounded overflow-hidden">
																...
																<div class="overlay-layer">
																	<a href="../dist/apps/shop/product.html" class="btn fw-bold btn-sm btn-primary me-2">Quick View</a>
																	<a href="../dist/apps/shop/product.html" class="btn fw-bold btn-sm btn-light-primary">Purchase</a>
																</div>
															</div>
															<!--end::Image-->
															<!--begin::Details-->
															<div class="text-center mt-5 mb-md-0 mb-lg-5 mb-md-0 mb-lg-5 mb-lg-0 mb-5 d-flex flex-column">
																<a href="../dist/apps/shop/product.html" class="fs-4 fw-bold text-gray-800 text-hover-primary mb-1">Smart Watches</a>
												...
												<div class="col-md-4 col-lg-12 col-xxl-4">
													...
													<div class="card shadow-none">
														<div class="card-body p-0">
															...
															<!--begin::Details-->
															<div class="text-center mt-5 mb-md-0 mb-lg-5 mb-md-0 mb-lg-5 mb-lg-0 mb-5 d-flex flex-column">
																<a href="../dist/apps/shop/product.html" class="fs-4 fw-bold text-gray-800 text-hover-primary mb-1">Headphones</a>
																<span class="fs-6">Outlines keep poorly thought</span>
															</div>
															<!--end::Details-->
														</div>
												...
												<div class="col-md-4 col-lg-12 col-xxl-4">
													...
													<div class="card shadow-none">
														<div class="card-body p-0">
															...
															<!--begin::Details-->
															<div class="text-center mt-5 mb-md-0 mb-lg-5 mb-md-0 mb-lg-5 mb-lg-0 mb-5 d-flex flex-column">
																<a href="../dist/apps/shop/product.html" class="fs-4 fw-bold text-gray-800 text-hover-primary mb-1">Smart Drones</a>
																<span class="fs-6">Outlines keep poorly thought</span>
															</div>
															<!--end::Details-->
														</div>
												...
												<div class="col-md-4 col-xxl-4 col-lg-12">
													...
													<div class="card shadow-none">
														<div class="card-body p-0">
															...
															<!--begin::Details-->
															<div class="text-center mt-5 mb-md-0 mb-lg-5 mb-md-0 mb-lg-5 mb-lg-0 mb-5 d-flex flex-column">
																<a href="../dist/apps/shop/product.html" class="fs-4 fw-bold text-gray-800 text-hover-primary mb-1">Jerry Kane</a>
																<span class="fs-6">Outlines keep poorly thought</span>
															</div>
															<!--end::Details-->
														</div>
												...
												<div class="col-md-4 col-lg-12 col-xxl-4">
													...
													<div class="card shadow-none">
														<div class="card-body p-0">
															...
															<!--begin::Details-->
															<div class="text-center mt-5 mb-md-0 mb-lg-5 mb-md-0 mb-lg-5 mb-lg-0 mb-5 d-flex flex-column">
																<a href="../dist/apps/shop/product.html" class="fs-4 fw-bold text-gray-800 text-hover-primary mb-1">Shiraz</a>
																<span class="fs-6">Outlines keep poorly thought</span>
															</div>
															<!--end::Details-->
														</div>
												...
												<div class="col-md-4 col-lg-12 col-xxl-4">
													...
													<div class="card shadow-none">
														<div class="card-body p-0">
															...
															<!--begin::Details-->
															<div class="text-center mt-5 mb-md-0 mb-lg-5 mb-md-0 mb-lg-5 mb-lg-0 mb-5 d-flex flex-column">
																<a href="../dist/apps/shop/product.html" class="fs-4 fw-bold text-gray-800 text-hover-primary mb-1">Chardonnay</a>
																<span class="fs-6">Outlines keep poorly thought</span>
															</div>
															<!--end::Details-->
														</div>
													...
													<div class="card shadow-none">
														<div class="card-body p-0">
															...
															<div class="overlay rounded overflow-hidden">
																...
																<div class="overlay-layer">
																	<a href="../dist/apps/shop/product.html" class="btn fw-bold btn-sm btn-primary me-2">Tommy Hilfiger</a>
																	<a href="../dist/apps/shop/product.html" class="btn fw-bold btn-sm btn-light-primary">Purchase</a>
																</div>
															</div>
															<!--end::Image-->
												...
												<div class="col-md-4 col-lg-12 col-xxl-4">
													...
													<div class="card shadow-none">
														<div class="card-body p-0">
															...
															<!--begin::Details-->
															<div class="text-center mt-5 mb-md-0 mb-lg-5 mb-md-0 mb-lg-5 mb-lg-0 mb-5 d-flex flex-column">
																<a href="../dist/apps/shop/product.html" class="fs-4 fw-bold text-gray-800 text-hover-primary mb-1">Hugo Boss</a>
																<span class="fs-6">Outlines keep poorly thought</span>
															</div>
															<!--end::Details-->
														</div>
												...
												<div class="col-md-4 col-lg-12 col-xxl-4">
													...
													<div class="card shadow-none">
														<div class="card-body p-0">
															...
															<!--begin::Details-->
															<div class="text-center mt-5 mb-md-0 mb-lg-5 mb-md-0 mb-lg-5 mb-lg-0 mb-5 d-flex flex-column">
																<a href="../dist/apps/shop/product.html" class="fs-4 fw-bold text-gray-800 text-hover-primary mb-1">Armani</a>
																<span class="fs-6">Outlines keep poorly thought</span>
															</div>
															<!--end::Details-->
														</div>
									...
									<div class="row">
										...
										<div class="col-sm-4">
											...
											<ul class="menu menu-column menu-fit menu-rounded menu-gray-600 menu-hover-primary menu-active-primary fw-semibold fs-6 mb-10">
												...
												<li class="menu-item">
													<a class="menu-link ps-0 py-2 active" href="../dist/apps/shop/shop-1.html">Shop 1</a>
												</li>
												<li class="menu-item">
