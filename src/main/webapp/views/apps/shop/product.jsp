						...
						<div class="toolbar" id="kt_toolbar">
							<div class="container-xxl d-flex flex-stack flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-nowrap text-nowrap overflow-auto py-1">
									...
									<a href="../dist/apps/shop/product.html" class="btn btn-active-accent active fw-bold ms-3">Shop Product</a>
								</div>
								<!--end::Nav-->
							</div>
						</div>
									...
									<div class="card">
										...
										<div class="card-header border-0 py-5">
											<h3 class="card-title align-items-start flex-column">
												<span class="card-label fw-bold text-dark">New Arrivals</span>
												<span class="text-muted mt-3 fw-semibold fs-7">More than 400+ new members</span>
											</h3>
											<div class="card-toolbar">
												<a href="#" class="btn btn-primary fw-bold fs-7">New Report</a>
											</div>
										</div>
										<!--end::Header-->
										<!--begin::Body-->
												...
												<table class="table align-middle border-gray-100" id="kt_advance_table_widget_4">
													<thead>
														<tr class="text-start text-muted fw-bold text-gray-400 text-uppercase fs-7 border-gray-100 border-bottom-1">
															...
															<td class="ps-0 min-w-250px py-5">Order id</td>
															<td class="min-w-100px py-5">Country</td>
													...
													<tbody>
														<tr>
															...
															<td class="ps-0">
																<a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">56037-XDER</a>
															</td>
															<td>
																<span class="text-gray-800 fw-bold d-block fs-6">Brasil</span>
																<span class="text-muted fw-semibold">Code: BR</span>
															</td>
															<td>
																<span class="text-success fw-bold d-block fs-6">05/28/2020</span>
														...
														<tr>
															...
															<td class="ps-0">
																<a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">05822-FXSP</a>
															</td>
															<td>
																<span class="text-gray-800 fw-bold d-block fs-6">Belarus</span>
																<span class="text-muted fw-semibold">Code: BY</span>
															</td>
															<td>
																<span class="text-success fw-bold d-block fs-6">02/04/2020</span>
																<span class="text-muted fw-semibold">Rejected</span>
															</td>
															<td>
														...
														<tr>
															...
															<td class="ps-0">
																<a href="#" class="text-gray-800 fw-bold text-hover-primary ont-size-lg">00347-BCLQ</a>
															</td>
															<td>
																<span class="text-gray-800 fw-bold d-block fs-6">Phillipines</span>
																<span class="text-muted fw-semibold">Code: PH</span>
															</td>
															<td>
																<span class="text-success fw-bold d-block fs-6">23/12/2020</span>
																<span class="text-muted fw-semibold">Paid</span>
															</td>
															<td>
														...
														<tr>
															...
															<td>
																<span class="text-gray-800 fw-bold d-block fs-6">Argentina</span>
																<span class="text-muted fw-semibold">Code: AR</span>
															</td>
															<td>
																<span class="text-success fw-bold d-block fs-6">17/09/2021</span>
									...
									<div class="row">
										...
										<div class="col-sm-4">
											...
											<ul class="menu menu-column menu-fit menu-rounded menu-gray-600 menu-hover-primary menu-active-primary fw-semibold fs-6 mb-10">
												...
												<li class="menu-item">
													<a class="menu-link ps-0 py-2 active" href="../dist/apps/shop/product.html">Shop Product</a>
												</li>
											</ul>
										</div>
										<div class="col-sm-4">
