						...
						<div class="toolbar" id="kt_toolbar">
							<div class="container-xxl d-flex flex-stack flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-1">
									<!--begin::Title-->
									<h3 class="text-dark fw-bold my-1">Shop 2</h3>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
									<ul class="breadcrumb breadcrumb-line bg-transparent text-muted fw-semibold p-0 my-1 fs-7">
										...
										<li class="breadcrumb-item text-dark">Shop 2</li>
									</ul>
									<!--end::Breadcrumb-->
								</div>
								<!--end::Info-->
								...
								<div class="d-flex align-items-center flex-nowrap text-nowrap overflow-auto py-1">
									...
									<a href="../dist/apps/shop/shop-2.html" class="btn btn-active-accent active fw-bold ms-3">Shop 2</a>
										...
										<div class="card mb-5 mb-xxl-8">
											<div class="card-body d-flex justify-content-between card-rounded p-0 d-flex" style="background-color:#F3F6F9;">
												<div class="d-flex flex-column flex-lg-row-auto py-10 py-md-14 px-10 px-md-20 pe-lg-0">
													<h1 class="fw-bold text-dark mb-0">Search Goods</h1>
													...
													<form class="d-flex flex-center py-2 px-6 bg-white rounded">
														...
														<!--end::Svg Icon-->
														<input type="text" class="form-control border-0 fw-semibold ps-2 w-xxl-600px" placeholder="Search Goods" />
													</form>
													<!--end::Form-->
												</div>
												<div class="d-none d-md-flex flex-row-fluid mw-400px ms-auto bgi-no-repeat bgi-position-y-center bgi-position-x-left bgi-size-contain" style="background-image: url(assets/media/illustrations/sigma-1/3.png);"></div>
											</div>
										</div>
										<!--end::Engage Widget 1-->
										<!--begin::Section-->
										<div class="row g-5 g-xxl-8">
											<div class="col-md-8 col-lg-12 col-xxl-8">
												...
												<div class="card mb-5 mb-xxl-8 overflow-hidden">
													<div class="card-body p-0 d-flex card-rounded bg-light-primary">
														<div class="py-18 px-12">
															<h3 class="fs-2x">
																<a href="#" class="text-dark text-hover-primary fw-bold">Nike Sneakers</a>
															</h3>
															<div class="fs-3 text-primary">Get Amazing Nike Sneakers</div>
														</div>
														<div class="d-none d-md-flex flex-row-fluid bgi-no-repeat bgi-position-y-center bgi-position-x-right bgi-size-cover" style="transform: translateX(10%) rotate(-26deg); background-image: url('assets/media/products/13.png')"></div>
													</div>
												</div>
												<!--end::Engage Widget 2-->
												<!--begin::Engage Widget 2-->
												<div class="card mb-0 mb-md-5 mb-lg-0 mb-xxl-8 overflow-hidden">
													<div class="card-body p-0 d-flex card-rounded bg-light-danger">
														...
														<div class="d-none d-md-flex flex-row-fluid bgi-no-repeat bgi-position-y-center bgi-position-x-right bgi-size-cover" style="transform: translateX(10%) rotate(-26deg); background-image: url('assets/media/products/12.png')"></div>
													</div>
												</div>
												<!--end::Engage Widget 2-->
											</div>
											<div class="col-md-4 col-lg-12 col-xxl-4">
												...
												<div class="card card-stretch mb-5 mb-xxl-8">
													<div class="card-body d-flex flex-column rounded bg-light-success justify-content-between">
														<div class="rounded text-center mb-7 pt-7">
															<img src="assets/media/products/14.png" class="mw-100 w-200px" alt="img" style="transform: scale(1.4);" />
														</div>
														<div class="text-center">
															<h3 class="fs-2x">
																<a href="../dist/apps/shop/product.html" class="text-dark text-hover-primary fw-bold">Kanken</a>
															</h3>
															<div class="fs-3 text-success">Amazing Backpack</div>
														</div>
													</div>
												</div>
										...
										<div class="row g-5 g-xxl-8">
												...
												<div class="card h-100">
													<div class="card-body d-flex flex-column rounded bg-light justify-content-between">
														<div class="text-center rounded mb-7">
															<img src="assets/media/products/15.png" class="mw-100 w-200px" alt="img" />
														</div>
														<div class="text-center">
															<h4 class="fs-4">
																<a href="../dist/apps/shop/product.html" class="text-gray-800 text-hover-primary fw-bold">Bose Headphones 700</a>
															</h4>
															<div class="fs-6 text-muted fw-bold">$370.00</div>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="col-md-4 col-lg-12 col-xxl-4">
												<div class="card h-100">
													<div class="card-body d-flex flex-column rounded bg-light justify-content-between">
														<div class="text-center rounded mb-7">
															<img src="assets/media/products/16.png" class="mw-100 w-200px" alt="img" />
														</div>
														<div class="text-center">
															<h4 class="fs-4">
																<a href="../dist/apps/shop/product.html" class="text-gray-800 text-hover-primary fw-bold">Amazon Bip Home</a>
															</h4>
															<div class="fs-6 text-muted fw-bold">$370.00</div>
														</div>
													</div>
											...
											<div class="col-md-4 col-lg-12 col-xxl-4">
												<div class="card h-100">
													<div class="card-body d-flex flex-column rounded bg-light justify-content-between">
														<div class="text-center rounded mb-7">
															<img src="assets/media/products/17.png" class="mw-100 w-200px" alt="img" />
														</div>
														<div class="text-center">
															<h4 class="fs-4">
																<a href="../dist/apps/shop/product.html" class="text-gray-800 text-hover-primary fw-bold">Black & White Vases</a>
															</h4>
															<div class="fs-6 text-muted fw-bold">$370.00</div>
														</div>
													</div>
											...
											<div class="col-md-4 col-lg-12 col-xxl-4">
												<div class="card h-100">
													<div class="card-body d-flex flex-column rounded bg-light justify-content-between">
														<div class="text-center rounded mb-7">
															<img src="assets/media/products/18.png" class="mw-100 w-200px" alt="img" />
														</div>
														<div class="text-center">
															<h4 class="fs-4">
																<a href="../dist/apps/shop/product.html" class="text-gray-800 text-hover-primary fw-bold">Spine Friendly Chair</a>
															</h4>
															<div class="fs-6 text-muted fw-bold">$370.00</div>
														</div>
													</div>
											...
											<div class="col-md-4 col-lg-12 col-xxl-4">
												<div class="card h-100">
													<div class="card-body d-flex flex-column rounded bg-light justify-content-between">
														<div class="text-center rounded mb-7">
															<img src="assets/media/products/19.png" class="mw-100 w-200px" alt="img" />
														</div>
														<div class="text-center">
															<h4 class="fs-4">
																<a href="../dist/apps/shop/product.html" class="text-gray-800 text-hover-primary fw-bold">Yellow Kettle</a>
															</h4>
															<div class="fs-6 text-muted fw-bold">$370.00</div>
														</div>
													</div>
											...
											<div class="col-md-4 col-lg-12 col-xxl-4">
												<div class="card h-100">
													<div class="card-body d-flex flex-column rounded bg-light justify-content-between">
														<div class="text-center rounded mb-7">
															<img src="assets/media/products/20.png" class="mw-100 w-200px" alt="img" />
														</div>
														<div class="text-center">
															<h4 class="fs-4">
																<a href="../dist/apps/shop/product.html" class="text-gray-800 text-hover-primary fw-bold">Amazing Mats</a>
															</h4>
															<div class="fs-6 text-muted fw-bold">$370.00</div>
														</div>
													</div>
							...
							<div class="hover-scroll-y me-lg-n7 pe-lg-5" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-offset="0px" data-kt-scroll-wrappers="#kt_sidebar_content">
								...
								<div class="d-none" id="kt_sidebar_shop_new_form">
									...
									<div class="d-flex flex-column text-center mb-10">
										<h3 class="fs-2 fw-bold mb-2">Add New Product</h3>
										<span class="text-muted fs-6 fw-bold">Quick Create Form</span>
									</div>
									<!--end::Heading-->
									<!--begin::Form-->
									<form class="form" method="post">
										...
										<div class="d-flex mb-8 justify-content-between">
											<!--begin::Symbol-->
											<div class="symbol symbol-70px me-4 bg-light">
											...
											<div class="symbol symbol-70px">
												<a href="#" class="h-70px w-70px btn btn-light d-flex flex-column flex-center fw-bold p-0">
												<!--begin::Svg Icon | path: icons/duotune/general/gen006.svg-->
												<span class="svg-icon svg-icon-1 svg-icon-gray-600 m-0">
													<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<!--begin::Product Info-->
										<div class="mt-5">
											<div class="mb-4 fw-bold fs-6">Product Info</div>
											<!--begin::Input-->
											<div class="mb-8">
											...
											<div class="mb-8">
												...
												<select class="form-select form-select-solid form-select-lg" data-control="select2" data-placeholder="Select Category..." data-hide-search="true">
											...
											<div class="mb-8">
												...
												<select class="form-select form-select-solid form-select-lg" data-control="select2" data-placeholder="Select Size..." data-hide-search="true">
											...
											<div class="mb-8">
												<label class="fw-bold">Price (Euro)</label>
												<input type="text" class="form-control form-control-solid form-control-lg" placeholder="" />
											</div>
											<button type="submit" class="btn btn-primary fw-bold me-2 px-8">Save</button>
											<button type="reset" id="kt_sidebar_shop_filter_form_btn" class="btn btn-color-gray-600 btn-active-light-primary fw-bold px-8">Discard</button>
											<!--end::Input-->
										</div>
										<!--end::Product Info-->
									</form>
								...
								<div id="kt_sidebar_shop_filter_form">
									...
									<div class="d-flex flex-column text-center bg-light rounded py-8 px-5 mb-10">
										<h3 class="fs-2 fw-bold mb-2">Add New Product</h3>
										<span class="text-muted fs-6 fw-bold">Quick Create Form</span>
										<button id="kt_sidebar_shop_new_form_btn" class="btn btn-primary fw-bold mx-auto px-5 mt-6">Create New</button>
									</div>
									<!--end::Heading-->
									<!--begin::Form-->
									<form class="form" method="post">
										<!--begin::Categories-->
										<div class="mb-11">
											<label class="fs-2 fw-bold text-dark mb-7">Categories</label>
											<!--begin::Categories list-->
											<div class="form-check form-check-custom form-check-solid mb-5">
												<input class="form-check-input" type="checkbox" id="kt_checkbox_1" value="1" />
												<label class="form-check-label fw-semibold text-gray-600" for="kt_checkbox_1">Electronics</label>
											</div>
											<div class="form-check form-check-custom form-check-solid mb-5">
												<input class="form-check-input" type="checkbox" id="kt_checkbox_2" value="1" />
												<label class="form-check-label fw-semibold text-gray-600" for="kt_checkbox_2">Sports Equipments</label>
											</div>
											<div class="form-check form-check-custom form-check-solid mb-5">
												<input class="form-check-input" type="checkbox" id="kt_checkbox_3" value="1" />
												<label class="form-check-label fw-semibold text-gray-600" for="kt_checkbox_3">Appliances</label>
											</div>
											<div class="form-check form-check-custom form-check-solid mb-5">
												<input class="form-check-input" type="checkbox" id="kt_checkbox_4" value="1" />
												<label class="form-check-label fw-semibold text-gray-600" for="kt_checkbox_4">Software Solutions</label>
											</div>
											<div class="form-check form-check-custom form-check-solid mb-5">
												<input class="form-check-input" type="checkbox" id="kt_checkbox_5" value="1" />
												<label class="form-check-label fw-semibold text-gray-600" for="kt_checkbox_4">Food & Groceries</label>
											</div>
											<!--end::Categories list-->
										</div>
										<!--end::Categories-->
										<!--begin::Prices-->
										<div class="mb-7">
											<label class="fs-2 fw-bold text-dark mb-7">Price</label>
											<!--begin::Price Options-->
											<div class="form-check form-check-custom form-check-solid mb-5">
												<input class="form-check-input" type="radio" id="kt_radio_1" value="1" name="prices" />
												<label class="form-check-label fw-semibold text-gray-600" for="kt_radio_1">All</label>
											</div>
											<div class="form-check form-check-custom form-check-solid mb-5">
												<input class="form-check-input" type="radio" id="kt_radio_2" value="1" name="prices" />
												<label class="form-check-label fw-semibold text-gray-600" for="kt_radio_2">0$ - 99$</label>
											</div>
											<div class="form-check form-check-custom form-check-solid mb-5">
												<input class="form-check-input" type="radio" id="kt_radio_3" value="1" name="prices" />
												<label class="form-check-label fw-semibold text-gray-600" for="kt_radio_3">100$ - 999$</label>
											</div>
											<div class="form-check form-check-custom form-check-solid mb-5">
												<input class="form-check-input" type="radio" id="kt_radio_4" value="1" name="prices" />
												<label class="form-check-label fw-semibold text-gray-600" for="kt_radio_4">1000$ & Above</label>
											</div>
											<!--end::Price Options-->
										</div>
										<!--end::Prices-->
										<!--begin::Price Slider-->
										<div class="mb-13">
											<div class="text-dark fw-bold fs-6 mb-5">Pricing Range</div>
											<div id="kt_price_slider" class="nouislider nouislider-light nouislider-handle-primary nouislider-bg-dark-15 nouislider-shadowless nouislider-borderless"></div>
										</div>
										<!--end::Price Slider-->
										<!--begin::Prices-->
										<div class="mb-11">
											<label class="fs-2 fw-bold text-dark mb-7">Sizes</label>
											<!--begin::Button Group-->
											<div class="d-flex" role="group">
												<input type="radio" class="btn-check" name="sizes" id="kt_size_1" />
												<label class="btn btn-active-primary btn-lg btn-icon btn-light btn-active-primary fw-semibold h-35px w-35px mx-1" for="kt_size_1">XS</label>
												<input type="radio" class="btn-check" name="sizes" id="kt_size_2" />
												<label class="btn btn-active-primary btn-lg btn-icon btn-light btn-active-primary fw-semibold h-35px w-35px mx-1" for="kt_size_2">S</label>
												<input type="radio" class="btn-check" checked="checked" name="sizes" id="kt_size_3" />
												<label class="btn btn-active-primary btn-lg btn-icon btn-light btn-active-primary fw-semibold h-35px w-35px mx-1" for="kt_size_3">M</label>
												<input type="radio" class="btn-check" name="sizes" id="kt_size_4" />
												<label class="btn btn-active-primary btn-lg btn-icon btn-light btn-active-primary fw-semibold h-35px w-35px mx-1" for="kt_size_4">L</label>
												<input type="radio" class="btn-check" name="sizes" id="kt_size_5" />
												<label class="btn btn-active-primary btn-lg btn-icon btn-light btn-active-primary fw-semibold h-35px w-35px mx-1" for="kt_size_5">XL</label>
											</div>
											<!--end::Button Group-->
										</div>
										<!--end::Prices-->
										<button type="reset" class="btn btn-primary fw-bold me-2 px-8">Reset</button>
										<button class="btn btn-color-gray-600 btn-active-light-primary fw-bold px-8">Setup</button>
									</form>
									<!--end::Form-->
								</div>
									...
									<div class="row">
										...
										<div class="col-sm-4">
											...
											<ul class="menu menu-column menu-fit menu-rounded menu-gray-600 menu-hover-primary menu-active-primary fw-semibold fs-6 mb-10">
												...
												<li class="menu-item">
													<a class="menu-link ps-0 py-2 active" href="../dist/apps/shop/shop-2.html">Shop 2</a>
												</li>
												<li class="menu-item">
