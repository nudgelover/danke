						...
						<div class="toolbar" id="kt_toolbar">
							<div class="container-xxl d-flex flex-stack flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-1">
									<!--begin::Title-->
									<h3 class="text-dark fw-bold my-1">Group Chat</h3>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
								...
								<div class="d-flex align-items-center flex-nowrap text-nowrap overflow-auto py-1">
									...
									<a href="../dist/apps/chat/group.html" class="btn btn-active-accent active fw-bold ms-3">Group Chat</a>
									...
									<div class="row">
										...
										<div class="col-sm-4">
											...
											<ul class="menu menu-column menu-fit menu-rounded menu-gray-600 menu-hover-primary menu-active-primary fw-semibold fs-6 mb-10">
												...
												<li class="menu-item">
													<a class="menu-link ps-0 py-2 active" href="../dist/apps/chat/group.html">Group Chat</a>
												</li>
												<li class="menu-item">
