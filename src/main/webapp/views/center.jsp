                    ...
                    <div class="card card-stretch mb-5 mb-xxl-8">
                        ...
                        <div class="card-body pb-0">
                            ...
                            <div class="d-flex flex-column h-100">
                                <!--begin::Text-->
                                <h3 class="text-dark text-center fs-1 fw-bold pt-15 lh-lg">Kickstart
                                    <br/>Mobile Application</h3>
                                <!--end::Text-->
                                <!--begin::Action-->
                                <div class="text-center pt-7">
                                    <a href="#" class="btn btn-primary fw-bold fs-6 px-7 py-3" data-bs-toggle="modal"
                                       data-bs-target="#kt_modal_create_campaign">Create App</a>
                                </div>
                                <!--end::Action-->
                                <!--begin::Image-->
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless align-middle">
                                            ...
                                            <tr>
                                                ...
                                                <td class="ps-0">
                                                    <a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Top
                                                        Authors</a>
                                                    <span class="text-muted fw-semibold d-block mt-1">HTML/CSS/JS, Python</span>
                                                </td>
                                                <td>
                                                    <div class="d-flex flex-column w-100 me-3">
                                                        <div class="d-flex flex-stack mb-2">
                                                            <span class="text-dark me-2 fs-6 fw-bold">Progress</span>
                                                        </div>
                                                        <div class="d-flex align-items-center">
                                                            <div class="progress h-6px w-100 bg-light-primary">
                                                                <div class="progress-bar bg-primary" role="progressbar"
                                                                     style="width: 46%;" aria-valuenow="50"
                                                                     aria-valuemin="0" aria-valuemax="100"></div>
                                                            </div>
                                                            <span class="text-muted fs-7 fw-semibold ps-3">46%</span>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="ps-0">
                                                    <a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Popular
                                                        Authors</a>
                                                    <span class="text-muted fw-semibold d-block mt-1">HTML, VueJS, Laravel</span>
                                                </td>
                                                <td>
                                                    <div class="d-flex flex-column w-100 me-3">
                                                        <div class="d-flex flex-stack mb-2">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="progress h-6px w-100 bg-light-warning">
                                                                <div class="progress-bar bg-warning" role="progressbar"
                                                                     style="width: 87%;" aria-valuenow="50"
                                                                     aria-valuemin="0" aria-valuemax="100"></div>
                                                            </div>
                                                            <span class="text-muted fs-7 fw-semibold ps-3">87%</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-end pe-0">
                                            ...
                                            <tr>
                                                ...
                                                <td class="ps-0">
                                                    <a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">New
                                                        Products</a>
                                                    <span class="text-muted fw-semibold d-block mt-1">HTML/CSS/JS, Python</span>
                                                </td>
                                                <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="progress h-6px w-100 bg-light-success">
                                                                <div class="progress-bar bg-success" role="progressbar"
                                                                     style="width: 53%;" aria-valuenow="50"
                                                                     aria-valuemin="0" aria-valuemax="100"></div>
                                                            </div>
                                                            <span class="text-muted fs-7 fw-semibold ps-3">53%</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-end pe-0">
                                            ...
                                            <tr>
                                                ...
                                                <td class="ps-0">
                                                    <a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Weekly
                                                        Bestsellers</a>
                                                    <span class="text-muted fw-semibold d-block mt-1">HTML/CSS/JS, Python</span>
                                                </td>
                                                <td>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="progress h-6px w-100 bg-light-danger">
                                                                <div class="progress-bar bg-danger" role="progressbar"
                                                                     style="width: 92%;" aria-valuenow="50"
                                                                     aria-valuemin="0" aria-valuemax="100"></div>
                                                            </div>
                                                            <span class="text-muted fs-7 fw-semibold ps-3">92%</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-end pe-0">
            ...
            <div class="row g-0 g-xl-5 g-xxl-8">
                <div class="col-xl-4">
                    ...
                    <div class="card card-stretch mb-5 mb-xxl-8">
                        ...
                        <div class="card-header align-items-center border-0 mt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="fw-bold text-dark fs-3">Sales Share</span>
                                <span class="text-muted mt-2 fw-semibold fs-6">890,344 Sales</span>
                            </h3>
                            <div class="card-toolbar">
                                <!--begin::Dropdown-->
                        ...
                        <div class="card-body pt-12">
                            ...
                            <div class="d-flex flex-center position-relative bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-center h-175px"
                                ...
                                <div class="fw-bold fs-1 text-gray-800 position-absolute">8,345</div>
                            ...
                            <div class="d-flex justify-content-around pt-18">
                                <!--begin::Item-->
                                <div class="">
                                    <span class="fw-bold text-gray-800">48% SNT</span>
                                    <span class="bg-info w-25px h-5px d-block rounded mt-1"></span>
                                </div>
                                <!--end::Item-->
                                <!--begin::Item-->
                                <div class="">
                                    <span class="fw-bold text-gray-800">20% REX</span>
                                    <span class="bg-primary w-25px h-5px d-block rounded mt-1"></span>
                                </div>
                                <!--end::Item-->
                                <!--begin::Item-->
                                <div class="">
                                    <span class="fw-bold text-gray-800">32% SAP</span>
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card card-stretch mb-5 mb-xxl-8">
                        ...
                        <div class="card-header align-items-center border-0 mt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="fw-bold text-dark fs-3">Milestones</span>
                                <span class="text-muted mt-2 fw-semibold fs-6">890,344 Sales</span>
                            </h3>
                            <div class="card-toolbar">
                                <!--begin::Dropdown-->
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column w-300px w-lg-350px p-5"
                                    ...
                                    <!--end::Input-->
                                    <!--begin::Tabs-->
                                    <ul class="nav nav-line-tabs nav-line-tabs-2x border-light fw-semibold mb-5">
                                        <li class="nav-item">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="kt_dropdown_2_tab_1">
                                            <ul class="menu menu-custom menu-column menu-rounded menu-title-gray-600 menu-icon-muted menu-hover-bg-light-primary menu-active-bg-light-primary fw-semibold">
                                                ...
                                                <li class="menu-item py-1">
                                                    <a href="#" class="menu-link px-3">
                                                        ...
                                                        <span class="menu-badge badge badge-light-danger fw-semibold">new</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item py-1">
                                                    <a href="#" class="menu-link px-3">
																			...
																			<span class="menu-icon">
																				...
																				<span class="svg-icon svg-icon-1">
																					<svg width="24" height="24"
                                                                                         viewBox="0 0 24 24" fill="none"
                                                                                         xmlns="http://www.w3.org/2000/svg">
																						<path d="M22 12C22 17.5 17.5 22 12 22C6.5 22 2 17.5 2 12C2 6.5 6.5 2 12 2C17.5 2 22 6.5 22 12ZM14.5 4.5C10.4 4.5 7 7.9 7 12C7 16.1 10.4 19.5 14.5 19.5C18.6 19.5 22 16.1 22 12C22 7.9 18.6 4.5 14.5 4.5Z"
                                                                                              fill="currentColor"/>
																						<path opacity="0.3"
                                            ...
                                            <ul class="menu menu-custom menu-column menu-rounded menu-title-gray-600 menu-icon-muted menu-hover-bg-light-primary menu-active-bg-light-primary fw-semibold">
                                                <li class="menu-item py-1">
                                                    <a href="#" class="menu-link active px-3">
                                                        ...
                                                        <span class="menu-title">Activity and Timeline</span>
                                                        <span class="menu-badge badge badge-danger fw-semibold">new</span>
                                                    </a>
                                                </li>
                                                <li class="menu-item py-1">
                                                    <a href="#" class="menu-link px-3">
                                    ...
                                    <ul class="nav flex-column nav-pills nav-pills-start">
                                        <li class="nav-item mb-3">
                                            <a class="nav-link active w-225px h-70px" data-bs-toggle="pill"
                                               id="kt_stats_widget_2_tab_1" href="#kt_stats_widget_2_tab_1_content">
                                                ...
                                                <div class="ps-1">
                                                    <span class="nav-text text-gray-600 fw-bold fs-6">Man&Flower SaaS</span>
                                                    <span class="text-muted fw-semibold d-block pt-1">HR Solutions</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="nav-item mb-3">
                                            <a class="nav-link w-225px h-70px" data-bs-toggle="pill"
                                               id="kt_stats_widget_2_tab_2" href="#kt_stats_widget_2_tab_2_content">
                                                <div class="nav-icon me-3">
                                                    <img alt="" src="/assets/media/svg/logo/gray/tower.svg"
                                                         class="default"/>
                                                    <img alt="" src="/assets/media/svg/logo/colored/tower.svg"
                                                         class="active"/>
                                                </div>
                                                <div class="ps-1">
                                                    <span class="nav-text text-gray-600 fw-bold fs-6">Building Studio</span>
                                                    <span class="text-muted fw-semibold d-block pt-1">HR Solutions</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="nav-item mb-3">
                                            <a class="nav-link w-225px h-70px" data-bs-toggle="pill"
                                               id="kt_stats_widget_2_tab_3" href="#kt_stats_widget_2_tab_3_content">
                                                <div class="nav-icon me-3">
                                                    <img alt="" src="/assets/media/svg/logo/gray/fox-hub-2.svg"
                                                         class="default"/>
                                                    <img alt="" src="/assets/media/svg/logo/colored/fox-hub-2.svg"
                                                         class="active"/>
                                                </div>
                                                <div class="ps-1">
                                                    <span class="nav-text text-gray-600 fw-bold fs-6">Foxy Solutions</span>
                                                    <span class="text-muted fw-semibold d-block pt-1">HR Solutions</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="nav-item mb-5">
                                            <a class="nav-link w-225px h-70px" data-bs-toggle="pill"
                                               id="kt_stats_widget_2_tab_4" href="#kt_stats_widget_2_tab_4_content">
                                                <div class="nav-icon me-3">
                                                    <img alt="" src="/assets/media/svg/logo/gray/kanba.svg"
                                                         class="default"/>
                                                    <img alt="" src="/assets/media/svg/logo/colored/kanba.svg"
                                                         class="active"/>
                                                </div>
                                                <div class="ps-1">
                                                    <span class="nav-text text-gray-600 fw-bold fs-6">MyStreams</span>
                                                    <span class="text-muted fw-semibold d-block pt-1">HR Solutions</span>
                                                </div>
                                            </a>
                                        </li>
                                ...
                                <div class="tab-content flex-grow-1">
                                    ...
                                    <div class="tab-pane fade" id="kt_stats_widget_2_tab_2_content">
                                        ...
                                        <div class="d-flex justify-content-center mb-10">
                                            ...
                                            <div class="px-10">
                                                <span class="text-muted fw-semibold fs-7">Sale</span>
                                                <span class="text-gray-800 fw-bold fs-3 d-block">$1250</span>
                                            </div>
                                            <!--end::Item-->
                                            <!--begin::Item-->
                                            <div class="px-10">
                                                <span class="text-muted fw-semibold fs-7">Commission</span>
                                                <span class="text-gray-800 fw-bold fs-3 d-block">$5,000</span>
                                            </div>
                                            <!--end::Item-->
                                            <!--begin::Item-->
                                            <div class="px-10">
                                                <span class="text-muted fw-semibold fs-7">Refers</span>
                                                <span class="text-gray-800 fw-bold fs-3 d-block">4,926</span>
                                            </div>
                                            <!--end::Item-->
                                        </div>
                                        <!--end::Content-->
                                    ...
                                    <div class="tab-pane fade" id="kt_stats_widget_2_tab_3_content">
                                        ...
                                        <div class="d-flex justify-content-center mb-10">
                                            ...
                                            <div class="px-10">
                                                <span class="text-muted fw-semibold fs-7">Sale</span>
                                                <span class="text-gray-800 fw-bold fs-3 d-block">$350</span>
                                            </div>
                                            <!--end::Item-->
                                            <!--begin::Item-->
                                            <div class="px-10">
                                                <span class="text-muted fw-semibold fs-7">Comission</span>
                                                <span class="text-gray-800 fw-bold fs-3 d-block">$1,200</span>
                                            </div>
                                            <!--end::Item-->
                                            <!--begin::Item-->
                                            <div class="px-10">
                                                <span class="text-muted fw-semibold fs-7">Refers</span>
                                                <span class="text-gray-800 fw-bold fs-3 d-block">5,500</span>
                                            </div>
                                            <!--end::Item-->
                                        </div>
                                        <!--end::Content-->
                                    ...
                                    <div class="tab-pane fade" id="kt_stats_widget_2_tab_4_content">
                                        ...
                                        <div class="d-flex justify-content-center mb-10">
                                            ...
                                            <div class="px-10">
                                                <span class="text-muted fw-semibold fs-7">Sale</span>
                                                <span class="text-gray-800 fw-bold fs-3 d-block">$450</span>
                                            </div>
                                            <!--end::Item-->
                                            <!--begin::Item-->
                                            <div class="px-10">
                                                <span class="text-muted fw-semibold fs-7">Comission</span>
                                                <span class="text-gray-800 fw-bold fs-3 d-block">$6,500</span>
                                            </div>
                                            <!--end::Item-->
                                            <!--begin::Item-->
                                            <div class="px-10">
                                                <span class="text-muted fw-semibold fs-7">Refers</span>
                                                <span class="text-gray-800 fw-bold fs-3 d-block">500</span>
                                            </div>
                                            <!--end::Item-->
                                        </div>
                                        <!--end::Content-->
            ...
            <div class="row g-0 g-xl-5 g-xxl-8">
                <div class="col-xl-4">
                    ...
                    <div class="card card-stretch mb-5 mb-xxl-8">
                        ...
                        <div class="card-header align-items-center border-0 mt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="fw-bold text-dark fs-3">Timeline</span>
                                <span class="text-muted mt-2 fw-semibold fs-6">Updates & notifications</span>
                            </h3>
                            <div class="card-toolbar">
                                <!--begin::Dropdown-->
                                <button type="button"
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card card-stretch mb-5 mb-xxl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold text-dark fs-3">Achievement</span>
                                <span class="text-muted mt-2 fw-semibold fs-6">890,344 Sales</span>
                            </h3>
                            <div class="card-toolbar">
                                <ul class="nav nav-pills nav-pills-sm nav-light">
                                    <li class="nav-item">
                                        <a class="nav-link btn btn-active-light btn-color-muted py-2 px-4 active fw-bold me-2"
                                           data-bs-toggle="tab" href="#kt_tab_pane_2_1">Day</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link btn btn-active-light btn-color-muted py-2 px-4 fw-bold me-2"
                                           data-bs-toggle="tab" href="#kt_tab_pane_2_2">Week</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link btn btn-active-light btn-color-muted py-2 px-4 fw-bold"
                                           data-bs-toggle="tab" href="#kt_tab_pane_2_3">Month</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless align-middle">
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-0">
                                                    <a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Brad
                                                        Simmons</a>
                                                    <span class="text-muted fw-semibold d-block mt-1">HTML, CSS Coding</span>
                                                </td>
                                                <td></td>
                                                <td class="text-end">
                                                    <span class="text-gray-800 fw-bold d-block fs-6">$1,200,000</span>
                                                    <span class="text-muted fw-semibold d-block mt-1 fs-7">Paid</span>
                                                </td>
                                                <td class="text-end">
                                                    <span class="fw-bold text-primary">+28%</span>
                                                </td>
                                                <td class="text-end pe-0">
                                                    <a href="#"
                                                       class="btn btn-icon btn-bg-light btn-active-primary btn-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-0">
                                                    <a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Jessie
                                                        Clarcson</a>
                                                    <span class="text-muted fw-semibold d-block mt-1">Most Successful</span>
                                                </td>
                                                <td></td>
                                                <td class="text-end">
                                                    <span class="text-gray-800 fw-bold d-block fs-6">$1,200,000</span>
                                                ...
                                                <td class="text-end">
                                                    <span class="fw-bold text-danger">+52%</span>
                                                </td>
                                                <td class="text-end pe-0">
                                                    <a href="#"
                                                       class="btn btn-icon btn-bg-light btn-active-primary btn-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-0">
                                                    <a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Lebron
                                                        Wayde</a>
                                                    <span class="text-muted fw-semibold d-block mt-1">Awesome Users</span>
                                                </td>
                                                <td></td>
                                                <td class="text-end">
                                                    <span class="text-gray-800 fw-bold d-block fs-6">$3,400,000</span>
                                                    <span class="text-muted fw-semibold d-block mt-1 fs-7">Paid</span>
                                                </td>
                                                <td class="text-end">
                                                    <span class="fw-bold text-warning">+34%</span>
                                                </td>
                                                <td class="text-end pe-0">
                                                    <a href="#"
                                                       class="btn btn-icon btn-bg-light btn-active-primary btn-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-0">
                                                    <a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Kevin
                                                        Leonard</a>
                                                    <span class="text-muted fw-semibold d-block mt-1">Awesome Userss</span>
                                                </td>
                                                <td></td>
                                                <td class="text-end">
                                                    <span class="text-gray-800 fw-bold d-block fs-6">$35,600,000</span>
                                                    <span class="text-muted fw-semibold d-block mt-1 fs-7">Paid</span>
                                                </td>
                                                <td class="text-end">
                                                    <span class="fw-bold text-success">+230%</span>
                                                </td>
                                                <td class="text-end pe-0">
                                                    <a href="#"
                                                       class="btn btn-icon btn-bg-light btn-active-primary btn-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-0">
                                                    <a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">Randy
                                                        Trent</a>
                                                    <span class="text-muted fw-semibold d-block mt-1">Business Analyst</span>
                                                </td>
                                                <td></td>
                                                <td class="text-end">
                                                    <span class="text-gray-800 fw-bold d-block fs-6">$45,200,000</span>
                                                    <span class="text-muted fw-semibold d-block mt-1 fs-7">Paid</span>
                                                </td>
                                                <td class="text-end">
                                                    <span class="fw-bold text-info">+340%</span>
                                                </td>
                                                <td class="text-end pe-0">
                                                    <a href="#"
                                                       class="btn btn-icon btn-bg-light btn-active-primary btn-sm">
