						...
						<div class="toolbar" id="kt_toolbar">
							<div class="container-xxl d-flex flex-stack flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-nowrap text-nowrap overflow-auto py-1">
									...
									<a href="../dist/profile/account.html" class="btn btn-active-accent active fw-bold ms-3">Account</a>
										...
										<div class="card-body mw-800px py-20">
											...
											<div class="row mb-8">
												...
												<div class="col-lg-9">
													<div class="spinner spinner-sm spinner-primary spinner-right">
														<input class="form-control form-control-lg form-control-solid" type="text" value="max_stone" />
													</div>
												</div>
											</div>
											<!--end::Form row-->
											...
											<div class="row mb-8">
												...
												<div class="col-lg-9">
													...
													<a href="#" class="fw-semibold">Learn more</a>.</div>
												</div>
											</div>
											<!--end::Form row-->
											<!--begin::Form row-->
											<div class="row mb-8">
												...
												<div class="col-lg-9">
													<select class="form-select form-select-lg form-select-solid" data-control="select2" data-placeholder="Select Language...">
											...
											<div class="row mb-8">
												...
												<div class="col-lg-9">
													<select class="form-select form-select-lg form-select-solid" data-control="select2" data-placeholder="Select Timezone...">
											...
											<div class="row mb-8">
												...
												<div class="col-lg-9">
													<button type="button" class="btn btn-light-primary fw-semibold btn-sm">Setup login verification</button>
													<div class="form-text">After you log in, you will be asked for additional information to confirm your identity and protect your account from being compromised.
													<a href="#" class="fw-semibold">Learn more</a>.</div>
												</div>
											</div>
											<!--end::Form row-->
											...
											<div class="row mb-13">
												...
												<div class="col-lg-9">
													<div class="form-check form-check-custom form-check-solid me-5">
														...
														<label class="form-check-label fw-semibold" for="customCheck5">Require personal information to reset your password.</label>
													</div>
													<div class="form-text py-2">For extra security, this requires you to confirm your email or phone number when you reset your password.
													<a href="#" class="fw-boldk">Learn more</a>.</div>
													<button type="button" class="btn btn-light-danger fw-semibold btn-sm">Deactivate your account ?</button>
												</div>
											</div>
											<!--end::Form row-->
											<!--begin::Form row-->
									...
									<div class="row">
										<div class="col-sm-4">
											...
											<ul class="menu menu-column menu-fit menu-rounded menu-gray-600 menu-hover-primary menu-active-primary fw-semibold fs-6 mb-10">
												...
												<li class="menu-item">
													<a class="menu-link ps-0 py-2 active" href="../dist/profile/account.html">Account</a>
												</li>
												<li class="menu-item">
