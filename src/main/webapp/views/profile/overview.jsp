						...
						<div class="toolbar" id="kt_toolbar">
							<div class="container-xxl d-flex flex-stack flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-nowrap text-nowrap overflow-auto py-1">
									<a href="../dist/profile/overview.html" class="btn btn-active-accent active fw-bold">Overview</a>
									<a href="../dist/profile/account.html" class="btn btn-active-accent fw-bold ms-3">Account</a>
									<a href="../dist/profile/settings.html" class="btn btn-active-accent fw-bold ms-3">Settings</a>
								</div>
								<!--end::Nav-->
							</div>
						</div>
												...
												<div class="d-flex align-items-center">
													...
													<div class="symbol symbol-45px me-5">
														<span class="symbol-label bg-light align-items-end">
															<img alt="Logo" src="assets/media/svg/avatars/007-boy-2.svg" class="mh-40px" />
														</span>
													</div>
													<!--end::Symbol-->
													<!--begin::Description-->
											...
											<div class="card-body pb-0">
												...
												<div class="d-flex align-items-center">
													...
													<div class="d-flex flex-column flex-grow-1">
														<a href="#" class="text-gray-800 text-hover-primary mb-1 fs-6 fw-bold">Grace Logan</a>
												...
												<form class="position-relative py-4 d-flex align-items-center pb-5">
													<textarea data-kt-autosize="true" class="form-control min-h-auto border-0 p-0 pe-10 resize-none" rows="1" placeholder="Reply..."></textarea>
										...
										<div class="card mb-5 mb-xxl-8">
											...
											<div class="card-body pb-0">
												...
												<div class="d-flex align-items-center">
													...
													<!--begin::Info-->
													<div class="d-flex flex-column flex-grow-1">
														<a href="#" class="text-gray-800 text-hover-primary mb-1 fs-6 fw-bold">Ruby Liam</a>
														<span class="text-muted fw-semibold">Yestarday at 5:06 PM</span>
													</div>
													<!--end::Info-->
													<!--begin::Dropdown Menu-->
													<div class="dropdown dropdown-inline">
														<button type="button" class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary" data-bs-toggle="dropdown">
															<!--begin::Svg Icon | path: icons/duotune/general/gen024.svg-->
														...
														<div class="dropdown-menu dropdown-menu-end w-md-325px p-0 m-0">
															<!--begin::Form-->
												...
												<div class="pt-4">
													<!--begin::Image-->
													<div class="bgi-no-repeat bgi-size-cover rounded min-h-250px" style="background-image:url('assets/media/stock/900x600/3.jpg');"></div>
													<!--end::Image-->
													<!--begin::Text-->
										...
										<div class="card mb-0 mb-xxl-8">
											...
											<div class="card-body pb-0">
												...
												<div class="">
													...
													<div>
														<!--begin::Text-->
														<p class="text-gray-800 fs-6 fw-normal">Outlines keep you honest. They stop you from indulging in poorly thought-out metaphors about driving and keep you focused on the overall structure of your post</p>
														<!--end::Text-->
														<!--begin::Action-->
														<div class="d-flex align-items-center">
															<a href="#" class="btn btn-sm btn-color-muted btn-active-light-primary fw-bold">
														...
														<div class="d-flex py-5">
															...
															<div class="symbol symbol-40px me-5">
																<span class="symbol-label bg-light align-items-end">
																	<img alt="Logo" src="assets/media/svg/avatars/009-boy-4.svg" class="mh-35px" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Info-->
															<div class="d-flex flex-column flex-row-fluid">
																...
																<div class="d-flex align-items-center flex-wrap">
																	<a href="#" class="text-gray-800 text-hover-primary mb-1 fs-6 fw-bold pe-6">Mr. Anderson</a>
																	<span class="text-muted fw-normal flex-grow-1 fs-7">1 Day ago</span>
																	<a href="#" class="text-muted text-hover-primary fw-normal fs-7">Reply</a>
																</div>
														...
														<div class="d-flex">
															...
															<div class="symbol symbol-40px me-5">
																<span class="symbol-label bg-light align-items-end">
																	<img alt="Logo" src="assets/media/svg/avatars/003-girl-1.svg" class="mh-35px" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Info-->
															<div class="d-flex flex-column flex-row-fluid">
																<!--begin::Info-->
																<div class="d-flex align-items-center flex-wrap">
																	<a href="#" class="text-gray-800 text-hover-primary mb-1 fs-6 fw-bold pe-6">Mrs. Anderson</a>
														...
														<tbody>
															<tr>
																<td class="ps-0">
																	<div class="symbol symbol-55px me-2 mt-1">
																		<span class="symbol-label align-items-end">
																			<img alt="icon" src="assets/media/svg/avatars/001-boy.svg" class="mh-40px" />
																		</span>
																	</div>
																</td>
																<td class="ps-0">
															...
															<tr>
																<td class="ps-0">
																	<div class="symbol symbol-55px me-2 mt-1">
																		<span class="symbol-label align-items-end">
																			<img alt="icon" src="assets/media/svg/avatars/018-girl-9.svg" class="mh-40px" />
																		</span>
																	</div>
																</td>
																<td class="ps-0">
															...
															<tr>
																<td class="ps-0">
																	<div class="symbol symbol-55px me-2 mt-1">
																		<span class="symbol-label align-items-end">
																			<img alt="icon" src="assets/media/svg/avatars/047-girl-25.svg" class="mh-40px" />
																		</span>
																	</div>
																</td>
																<td class="ps-0">
															...
															<tr>
																<td class="ps-0">
																	<div class="symbol symbol-55px me-2 mt-1">
																		<span class="symbol-label align-items-end">
																			<img alt="icon" src="assets/media/svg/avatars/043-boy-18.svg" class="mh-40px" />
																		</span>
																	</div>
																</td>
																<td class="ps-0">
											...
											<div class="card-header border-0 pt-5">
												...
												<div class="card-toolbar">
													<ul class="nav nav-pills nav-pills-sm nav-light">
														<li class="nav-item">
															<a class="nav-link btn btn-active-light btn-color-muted py-2 px-4 active fw-bold me-2" data-bs-toggle="tab" href="#kt_tab_pane_1_1">Week</a>
														</li>
														<li class="nav-item">
															<a class="nav-link btn btn-active-light btn-color-muted py-2 px-4 fw-bold me-2" data-bs-toggle="tab" href="#kt_tab_pane_1_2">Month</a>
														</li>
													</ul>
												</div>
											</div>
															...
															<div class="mt-5 px-9">
																	...
																	<div class="d-flex align-items-center me-2">
																		...
																		<div class="symbol symbol-50px symbol-light me-5">
																			<span class="symbol-label">
																				<img src="assets/media/svg/brand-logos/plurk.svg" alt="" class="mw-75" />
																			</span>
																		</div>
																		<!--end::Symbol-->
																		<!--begin::Title-->
																		<div>
																			<a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Pipeline Theme</a>
																...
																<div class="d-flex flex-stack mb-6">
																	...
																	<div class="d-flex align-items-center me-2">
																		...
																		<div class="symbol symbol-50px symbol-light me-5">
																			<span class="symbol-label">
																				<img src="assets/media/svg/brand-logos/telegram.svg" alt="" class="mw-75" />
																			</span>
																		</div>
																		<!--end::Symbol-->
																		<!--begin::Title-->
																		<div>
																			<a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold">ThumbsUp HTML</a>
																			<div class="fs-7 text-muted fw-semibold mt-1">Most Successful Fellas</div>
																		</div>
																		<!--end::Title-->
																	</div>
																	<!--end::Section-->
																	<!--begin::Label-->
																	<div class="bg-light rounded fw-bold text-gray-600 py-2 px-3">+280$</div>
																	<!--end::Label-->
																</div>
																<!--end::Widget Item-->
																<!--begin::Widget Item-->
																<div class="d-flex flex-stack">
																	...
																	<div class="d-flex align-items-center me-2">
																		...
																		<div class="symbol symbol-50px symbol-light me-5">
																			<span class="symbol-label">
																				<img src="assets/media/svg/misc/puzzle.svg" alt="" class="mw-75" />
																			</span>
																		</div>
																		<!--end::Symbol-->
																		<!--begin::Title-->
																		<div>
																			<a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Finder Admin</a>
																			<div class="fs-7 text-muted fw-semibold mt-1">Most Successful Fellas</div>
																		</div>
																		<!--end::Title-->
																	</div>
																	<!--end::Section-->
																	<!--begin::Label-->
																	<div class="bg-light rounded fw-bold text-gray-600 py-2 px-3">+4500$</div>
																	<!--end::Label-->
																</div>
																<!--end::Widget Item-->
															</div>
										...
										<div class="pt-0">
											...
											<div class="pt-4">
												...
												<div class="text-center pb-12">
													<!--begin::Username-->
													<h3 class="fw-bold text-white fs-2 pb-4">Mr. Anderson</h3>
													<!--end::Username-->
													<!--end::Action-->
													<span class="fw-bold fs-6 text-primary px-4 py-2 rounded bg-white bg-opacity-10">Python Dev</span>
													<!--begin::Action-->
												</div>
												<!--end::Title-->
												<!--begin::Row-->
												<div class="row row-cols-2 px-xl-12 sidebar-toolbar">
													<div class="col p-3">
														<a href="#" class="btn p-5 w-100 text-start btn-active-primary">
															<span class="text-white fw-bold fs-1 d-block pb-1">38</span>
															<span class="fw-semibold">Pending</span>
														</a>
													</div>
													<div class="col p-3">
														<a href="#" class="btn p-5 w-100 text-start btn-active-primary">
															<span class="text-white fw-bold fs-1 d-block pb-1">204</span>
															<span class="fw-semibold">Completed</span>
														</a>
													</div>
													<div class="col p-3">
														<a href="#" class="btn p-5 w-100 text-start btn-active-primary">
															<span class="text-white fw-bold fs-1 d-block pb-1">76</span>
															<span class="fw-semibold">On Hold</span>
														</a>
													</div>
													<div class="col p-3">
														<a href="#" class="btn p-5 w-100 text-start btn-active-primary">
															<span class="text-white fw-bold fs-1 d-block pb-1">9</span>
								...
								<div class="col-lg-6 pe-lg-25">
									...
									<div class="row">
										<div class="col-sm-4">
											...
											<ul class="menu menu-column menu-fit menu-rounded menu-gray-600 menu-hover-primary menu-active-primary fw-semibold fs-6 mb-10">
												<li class="menu-item">
													<a class="menu-link ps-0 py-2 active" href="../dist/profile/overview.html">Overview</a>
												</li>
												<li class="menu-item">
