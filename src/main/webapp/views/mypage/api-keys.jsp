    ...
    <div class="toolbar" id="kt_toolbar">
        <div class="container-xxl d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-1">
                <!--begin::Title-->
                <h3 class="text-dark fw-bold my-1">API Keys</h3>
                <!--end::Title-->
            </div>
            <!--end::Info-->
        </div>
                ...
                <div class="card-body py-10">
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-6 pb-10 pb-lg-0">
                            ...
                            <p class="fs-6 fw-semibold text-gray-600 py-2">Use images to enhance your post,
                                improve its flow, add humor
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="fs-6 fw-semibold text-gray-600 py-2">Plan your blog post by choosing a
                                topic, creating an outline conduct
                        ...
                        <div class="d-flex flex-stack flex-grow-1">
                            ...
                            <div class="fw-semibold">
                                <div class="fs-6 text-gray-700">Two-factor authentication adds an extra
                                    ...
                                    a 4 digit amazing and create outstanding products to serve your clients
