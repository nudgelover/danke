                    ...
                    <div class="card-body d-flex p-12 flex-column flex-md-row flex-lg-column flex-xxl-row">
                        ...
                        <div class="card shadow-none w-auto w-md-300px w-lg-auto w-xxl-300px ml-auto">
                            ...
                            <div class="d-flex justify-content-center">
                                <a href="javascript:void(0)" id="cart_btn" class="btn btn-light-primary fw-bolder" style="width: 50%;margin-right: 4%">
                                ...
                                <a href="javascript:void(0)" id="curri_btn" class="btn btn-light-danger fw-bolder" style="width:50%">
                                    <span class="svg-icon svg-icon-1">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
