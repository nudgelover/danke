                ...
                <div class="col-xl-6">
                    ...
                    <div class="card mb-5 mb-xxl-8">
                        ...
                        <div class="card-body pb-0">
                            ...
                            <div class="pt-5">
                                <!--begin::Text-->
                                <p class="text-gray-800 fs-6 fw-normal mb-2">Outlines keep you honest. They stop you
                                    from indulging in poorly thought-out metaphors about driving and keep you focused on
                                            ...
                                            <ul class="nav nav-line-tabs nav-line-tabs-2x border-light fw-semibold mb-5">
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-bs-toggle="tab"
                                                       href="#kt_dropdown_2_tab_1">Today</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-bs-toggle="tab"
                                                       href="#kt_dropdown_2_tab_2">Last Week</a>
                                                </li>
                                            </ul>
                                            <!--end::Tabs-->
                                            <!--begin::Tab Content-->
