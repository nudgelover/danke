            ...
            <div class="card">
                ...
                <form class="form d-flex flex-center">
                    <div class="card-body mw-800px py-20">
                        <a href="https://preview.keenthemes.com/html/start-html-pro/docs/forms/password-meter">use this!!!!!!!!!!!</a>
                         <a href="https://preview.keenthemes.com/html/start-html-pro/docs/general/sweetalert">register OK alert!</a>   <!--begin::Form row-->
                            <div class="row mb-8">
                            ...
                            <div class="row mb-8">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <div class="form-text">After you log in, you will be asked for additional
                                        information to
                            ...
                            <div class="row mb-13">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <div class="form-text py-2">For extra security, this requires you to confirm your
                                        email
                                        or phone number when you reset your password.
                                        <a href="#" class="fw-boldk">Learn more</a>.
                                    </div>
                                    <button type="button" class="btn btn-light-danger fw-semibold btn-sm">Deactivate
                                        your
                                        account ?
                                    </button>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <button type="reset"
                                            class="btn btn-color-gray-600 btn-active-light-primary fw-bold px-6 py-3">
                                        Cancel
                                    </button>
                                </div>
                            </div>
