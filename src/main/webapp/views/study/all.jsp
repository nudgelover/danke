            ...
            <div class="row g-xxl-9">
                <div class="col-xxl-8">
                    <div class="carousel carousel-custom slide card card-xxl-stretch mb-5 mb-xxl-10" id="kt_carousel_3_carousel" data-bs-ride="carousel" data-bs-interval="8000">
                        ...
                        <div class="card-body pb-0 carousel-inner pt-8">
                            <c:forEach var="rank" items="${rank}" begin="0" end="0">
                                <div class="carousel-item active">
                                    <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                                        <div class="me-7 mb-4">
                                            <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                                <img src="/uimg/${rank.stdnImg}" alt="image"/>
                                            ...
                                            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                                <div class="d-flex flex-column">
                                                    <div class="d-flex align-items-center mb-2">
                                                        <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">${rank.stdnName}</a>
                                                        <a href="#">
                                            <span class="svg-icon svg-icon-1 svg-icon-primary">
                                                ...
                                                <div class="d-flex my-4">
                                                    <button class="btn btn-sm btn-light-primary fw-bold send-message-btn" data-kt-drawer-show="true"
                                                            data-student-id="${rank.writer}" data-kt-drawer-target="#kt_drawer_chat">축하 메시지 보내기
                                                    </button>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3 bg-light-danger">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="fs-2 fw-bold text-center" data-kt-countup="true"
                                                                     data-kt-countup-value="${rank.monthlyCnt}"
                                                        ...
                                                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3 bg-light-warning">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="fs-2 fw-bold" data-kt-countup="true"
                                                                     data-kt-countup-value="${rank.monthlyDuration}"
                                                                     data-kt-countup-suffix="분" data-kt-countup-prefix="총 ">0
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3 bg-light-info">
                                                            <div class="fw-semibold fs-6 text-gray-800">이번달 받은 좋아요</div>
                                                            <div class="d-flex align-items-center">
                                                                <div class="fs-2 fw-bold" data-kt-countup="true"
                                                                     data-kt-countup-value="${rank.monthlyLikes}"
                            ...
                            <c:forEach var="rank" items="${rank}" begin="1" end="2">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-self-center">
                                <div class="flex-grow-1 me-3">
                                    <span class="fs-5 fw-bolder text-gray-700 px-3 pb-6 d-block">
                                        동료들과 인사이트를 나눠보세요!<br>
                                        더 빨리, 더 멀리 갈 수 있어요!
                                    </span>
                                    <form action="/study/findimpl" method="get">
                                        ...
                                        <div class="d-flex justify-content-center mt-3">
                                            <input type="text" id="search" name="search"
                                                   <c:if test="${stdySearch.search!=null}">value="${stdySearch.search}"</c:if>
                                                   class="form-control form-control-solid me-2" placeholder="입력하세요"/>
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle table-row-bordered table-row-solid gy-4 gs-9 ">
                                ...
                                <tr class="text-center fw-bolder">
                                    <th class="ps-9" style="width: 20%">이름</th>
                                ...
                                <c:forEach var="stdy" items="${cpage.getList()}">
                                    <tr>
                                        <td class="ps-9 text-center">
                                            <div class="symbol symbol-50px symbol-circle me-5n">
                                                <img alt="Pic" class="mx-2" src="/uimg/${stdy.stdnImg}"/>
                                                <span class="text-gray-800 fs-8 fw-bolder mx-2">${stdy.stdnName}</span>
                                            </div>
                                        </td>
                                        <td class="text-center">${stdy.rdate}</td>
                                        <td class="text-center"><span class="badge badge-light-primary" mx-1>총 ${stdy.duration}</span></td>
                                        ...
                                        <td class="text-center text-success">${stdy.likes}</td>
